...
def augment_image(img_ref, augmentation = "rotate", angles = [0, 5, 10, 15, 20, -5, -10, -15, -20]):
    """
...
def get_dataset_info(dataset, preprocess):
    ...
    # for paper_pack dataset    
    elif dataset == "kagome":
        objects = ["paper_pack", "ketchup", "01_omote", "02_ura", "01_omote_crop", "02_ura_crop"]
        object_anomalies = {"paper_pack": ["almond", "fruit", "other", "yasai_ippon", "yasai_seikatu"],
                            "ketchup":["bad"],
                            "01_omote":["bad"],
                            "02_ura":["bad"],
                            "01_omote_crop":["bad"],
